...
TrailingSchema = Schema((
    ...
    LinesField('keywords',
        ...
        widget=KeywordWidget(
                ...
                description=_(u'help_keywords', default=u'Categorization of the publications content.'),
                i18n_domain = "cmfbibliographyat",
                ),
        ),
    LinesField('openscience_keywords',
        searchable=1,
        required=0,
        languageIndependent=1,
        is_duplicates_criterion=False,
        multiValued=1,
        widget=KeywordWidget(
                label=_(u'label_openscience_keywords', default=u'Openscience Keywords'),
                description=_(u'help_keywords', default=u'Openscience categorization of the publications content.'),
                i18n_domain = "cmfbibliographyat",
            ),
        ),
